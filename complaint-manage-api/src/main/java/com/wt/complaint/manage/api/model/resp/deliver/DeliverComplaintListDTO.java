...
@AllArgsConstructor
@NoArgsConstructor
public class DeliverComplaintListDTO implements Serializable {
    ...
    @ApiDocClassDefine(value = "responsible", description = "责任情况,  1-有责 2-无责 3-待判�?)
    private Integer responsible;
    @ApiDocClassDefine(value = "responsibleName", description = "责任情况,  1-有责 2-无责 3-待判�?)
