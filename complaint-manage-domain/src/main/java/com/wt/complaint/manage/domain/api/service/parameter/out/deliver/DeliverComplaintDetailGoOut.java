...
import com.wt.complaint.manage.api.model.enums.DeliverComplaintDetailButtonEnum;
import com.wt.complaint.manage.api.model.req.operate.TemplateField;
import com.wt.complaint.manage.api.model.resp.deliver.ProgressBarDTO;
...
/**
 * 交付客诉详情出参
 * 包括客诉情况、响应情况、判责情况等字段信息
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
public class DeliverComplaintDetailGoOut  {
    ...
    @ApiDocClassDefine(value = "customerServicePhone", description = "客服人员电话")
    ...
    public static class Button implements Serializable {
        ...
        /**
         * 公有构造器初始化按�?
         * @param buttonEnum 按钮枚举值，包括了按钮的key和描述信�?
         */
        public Button(DeliverComplaintDetailButtonEnum buttonEnum) {
            this.buttonKey = buttonEnum.getCode();
            this.buttonName = buttonEnum.getDesc();
            this.disabled = false;
        }
    }
}
