...
@NoArgsConstructor
@Builder
public class StaticRetailCountSoIn implements Serializable {

    private static final long serialVersionUID = -5657072414704645526L;
     ...
     * 售后工作台权�?
     */
    private StaticRetailCountSoIn.AfterSaleWorkbenchPermissionGroup afterSaleWorkbenchPermissionGroup;

    @NoArgsConstructor
    @Data
    public static class AfterSaleWorkbenchPermissionGroup implements Serializable {

        private static final long serialVersionUID = 914147509612023899L;
