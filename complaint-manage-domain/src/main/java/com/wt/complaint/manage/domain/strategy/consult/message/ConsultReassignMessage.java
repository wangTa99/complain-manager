...
import static com.wt.complaint.manage.domain.api.enums.PushEnum.CONSULT_REASSIGN_ONLY;
import static com.wt.complaint.manage.domain.constant.ComplaintInfoConstant.ORG_NAME;

@Slf4j
@Service(PushConstant.CONSULT_REASSIGN)
public class ConsultReassignMessage  extends AbstractConsultMessageInformedStrategy {
    @Override
    public MessageInformedEvent createMessageInformedEvent(UserConsultOrderInfo soOut, Map<String, String> extraParam) {
        ...
        return MessageInformedEvent.builder()
                ...
                .pushEnum(CONSULT_REASSIGN_ONLY)
    ...
    private Map<String, String> constructNrBoxPayload(UserConsultOrderInfo soOut, String message,
