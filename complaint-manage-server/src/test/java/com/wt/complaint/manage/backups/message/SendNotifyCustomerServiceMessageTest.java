...
public class SendNotifyCustomerServiceMessageTest {
    ...
    @Test
    public void sendNotifyCustomerServiceMessageTest() {
        UserComplaintOrderDetailSoOut soOut =
                userComplaintOrderGateway.selectDetailByUcNo("RP256461037383228");
