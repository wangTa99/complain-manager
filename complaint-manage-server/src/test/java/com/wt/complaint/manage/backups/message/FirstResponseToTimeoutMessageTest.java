...
import com.wt.complaint.manage.domain.strategy.message.FirstResponseToTimeoutMessage;
...
public class FirstResponseToTimeoutMessageTest {

    @Resource
    private FirstResponseToTimeoutMessage firstResponseToTimeoutMessage;
    ...
    public void testNewComplaintMessageToDeal() {
        ...
        MessageInformedEvent messageInformedEvent = firstResponseToTimeoutMessage.createMessageInformedEvent(complaintOrderGoOut, new HashMap<>());
    ...
    @Test
    public void coolRequestNewComplaintMessageToDeal1() {
    ...
    @Test
    public void coolRequestNewComplaintMessageToDeal2() {
        String complaintNo = "RC248441000051378";
        ComplaintBasicInfo complaintBasicInfo = new ComplaintBasicInfo();
        complaintBasicInfo.setDrNo(complaintNo);
        complaintBasicInfo.setOperatorPositionId(85);
    ...
    @Test
    public void coolRequestNewComplaintMessageToDeal3() {
        String complaintNo = "RC248441000051378";
        ComplaintBasicInfo complaintBasicInfo = new ComplaintBasicInfo();
        complaintBasicInfo.setDrNo(complaintNo);
        complaintBasicInfo.setOperatorPositionId(85);
